...
| @tauri-apps/cli | 2.11.0 | Apache-2.0 OR MIT |
...
Version 2.11.0, alle unter „Apache-2.0 OR MIT“). Sie werden nur zur Bauzeit
...
Insgesamt 537 direkte und transitive Abhängigkeiten.
...
| notify-rust | 4.16.1 | MIT/Apache-2.0 |
